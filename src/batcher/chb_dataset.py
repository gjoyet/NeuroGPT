...
class CHBDataset_NPZ(EEGDataset):
    ...
    def __getitem__(self, idx):
        return self.preprocess_sample(self.trials[idx], self.num_chunks, self.labels[idx], input_position=551)
...
class CHBDataset_HDF5(EEGDataset):
    ...
    def __getitem__(self, index):
        ...
        return self.preprocess_sample(np.array(trial), 1, np.array(label), input_position=select)
